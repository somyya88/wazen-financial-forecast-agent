...
def build_revenue_quality(monthly_df):
    ...
    if quality_status == "يحتاج تحقق":
        risk = "الخطر أن يتم بناء قرار توسع أو مصروف ثابت على متوسط إيراد متأثر بشهر مرتفع أو تذبذب غير مفسر."
        action = "قبل أي توسع، افصل الإيراد المتكرر عن الإيراد الاستثنائي، وحلل أعلى 5 عملاء أو عقود خلال الفترة."
